...
--STEP 2
--Insert the values given in CSV files into Each Table:
...
SELECT * FROM offices; --(To verify if the values are inserted properly into the table)
...
(10102, '2003-01-10', '2003-01-18', '2003-01-14', 'Shipped', NULL, 112),
(10103, '2003-01-29', '2003-02-07', '2003-02-02', 'Shipped', NULL, 121),
(10104, '2003-01-31', '2003-02-09', '2003-02-01', 'Shipped', NULL, 141),
(10105, '2003-02-11', '2003-02-21', '2003-02-12', 'Shipped', NULL, 145),
(10106, '2003-02-17', '2003-02-24', '2003-02-21', 'Shipped', NULL, 114),
...
(10109, '2003-03-10', '2003-03-19', '2003-03-11', 'Shipped', 'Customer requested that FedEx Ground is used for this shipping.', 125),
(10110, '2003-03-18', '2003-03-24', '2003-03-20', 'Shipped', NULL, 146),
...
(10114, '2003-04-01', '2003-04-07', '2003-04-02', 'Shipped', NULL, 151),
(10115, '2003-04-04', '2003-04-12', '2003-04-07', 'Shipped', NULL, 157),
(10116, '2003-04-11', '2003-04-19', '2003-04-13', 'Shipped', NULL, 161),
...
--Insert Values into Productlines:
...
('S10_1949', '1952 Alpine Renault 1300', 'Classic Cars', '01:10', 'Classic Metal Creations', 'Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.', 7305, 98.58, 214.30),
...
('S10_4757', '1972 Alfa Romeo GTA', 'Classic Cars', '01:10', 'Motor City Art Classics', 'Features include: Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.', 3252, 85.68, 136.00),
...
('S12_1108', '2001 Ferrari Enzo', 'Classic Cars', '01:12', 'Second Gear Diecast', 'Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.', 3619, 95.59, 207.80),
('S12_1666', '1958 Setra Bus', 'Trucks and Buses', '01:12', 'Welly Diecast Productions', 'Model features 30 windows, skylights & glare resistant glass, working steering system, original logos', 1579, 77.90, 136.67),
...
('S12_3148', '1969 Corvair Monza', 'Classic Cars', '01:18', 'Welly Diecast Productions', '1:18 scale die-cast about 10 long doors open, hood opens,trunk opens and wheels roll""', 6906, NULL, NULL),
...
('S12_4473', '1957 Chevy Pickup', 'Trucks and Buses', '01:12', 'Exoto Designs', '1:12 scale die-cast about 20 long Hood opens," Rubber wheels""', 6125, 55.70, NULL),
